...
class hz_gov_Spider(scrapy.Spider):
    name = "sanming_zhongbiao.py"
    allowed_domains = ["www.smggzy.com"]
    ...
    def start_requests(self):
        urls = [
            "http://www.smggzy.com/smwz/gcjsjy/010003/MoreInfo.aspx?CategoryNum=010003",
            "http://www.smggzy.com/smwz/zfcg/011003/MoreInfo.aspx?CategoryNum=011003",
            'http://www.smggzy.com/smwz/zhjy/014003/MoreInfo.aspx?CategoryNum=014003'
        ]
    ...
    def middle(self, response):
        ...
        for i in range(len(names)):
            url = "http://www.smggzy.com" + "".join(urls[i])
