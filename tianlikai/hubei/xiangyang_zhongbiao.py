...
class hz_gov_Spider(scrapy.Spider):
    name = "xiangyang_zhongbiao.py"
    allowed_domains = ["www.xysztb.gov.cn"]
    ...
    def start_requests(self):
        urls = [
            "http://www.xysztb.gov.cn/xyzbw/jyxx/002001/002001004/MoreInfo.aspx?CategoryNum=002001004",
            "http://www.xysztb.gov.cn/xyzbw/jyxx/002002/002002003/MoreInfo.aspx?CategoryNum=002002003"
        ]
    ...
    def middle(self, response):
        ...
        for i in range(len(names)):
            url = "http://www.xysztb.gov.cn" + "".join(urls[i])
