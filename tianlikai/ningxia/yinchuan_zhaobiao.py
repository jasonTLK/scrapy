...
class hz_gov_Spider(scrapy.Spider):
    name = "yinchuan_zhaobiao.py"
    allowed_domains = ["www.ycsggzy.cn"]
    ...
    def start_requests(self):
        urls = [
            "http://www.ycsggzy.cn/morelink.aspx?type=12&index=2&isbg=0",
        ...
        while start <= page:
            yield FormRequest(url=url,
                              formdata={
                                  ...
                                  'pager_input': str(start-1)}, headers=headers,
    ...
    def middle(self, response):
        ...
        selector = Selector(response)
        urls = selector.xpath("//table[@id='GV1']//a/@href").extract()
        ...
        for i in range(len(names)):
            url = "http://www.ycsggzy.cn/" + "".join(urls[i])
