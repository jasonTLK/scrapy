...
class hz_gov_Spider(scrapy.Spider):
    name = "sanya_zhongbiao.py"
    allowed_domains = ["ztb.sanya.gov.cn"]
    ...
    def start_requests(self):
        urls = [
            "http://ztb.sanya.gov.cn/sanyaztb/jyxx/001001/001001004/MoreInfo.aspx?CategoryNum=001001004",
            "http://ztb.sanya.gov.cn/sanyaztb/jyxx/001002/001002004/MoreInfo.aspx?CategoryNum=001002004"
        ]
    ...
    def middle(self, response):
        ...
        for i in range(len(names)):
            url = "http://ztb.sanya.gov.cn" + "".join(urls[i])
