...
class hz_gov_Spider(scrapy.Spider):
    name = "fangchenggang_zhaobiao.py"
    allowed_domains = ["fcg.gxggzy.cn"]
    ...
    def start_requests(self):
        urls = [
            "http://fcg.gxggzy.cn/gxfcgzbw/jyxx/001004/001004001/MoreInfo.aspx?CategoryNum=001004001",
            "http://fcg.gxggzy.cn/gxfcgzbw/jyxx/001001/001001001/MoreInfo.aspx?CategoryNum=001001001",
            "http://fcg.gxggzy.cn/gxfcgzbw/jyxx/001011/001011001/MoreInfo.aspx?CategoryNum=001011001",
            "http://fcg.gxggzy.cn/gxfcgzbw/jyxx/001010/001010001/MoreInfo.aspx?CategoryNum=001010001",
            "http://fcg.gxggzy.cn/gxfcgzbw/jyxx/001009/001009001/MoreInfo.aspx?CategoryNum=001009001"
        ]
        ...
        while start <= page:
            yield FormRequest(url=url,
                              formdata={
                                  ...
                                  '__EVENTTARGET': 'MoreInfoListZbgs2$Pager',
    ...
    def middle(self, response):
        ...
        for i in range(len(names)):
            url = "http://fcg.gxggzy.cn" + "".join(urls[i])
