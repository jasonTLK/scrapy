...
class hz_gov_Spider(scrapy.Spider):
    name = "hechi_zhaobiao.py"
    allowed_domains = ["www.hcggzy.cn"]
    ...
    def start_requests(self):
        urls = [
            "http://www.hcggzy.cn/gxhczbw/jyxx/001001/001001001/MoreInfo.aspx?CategoryNum=001001001",
            'http://www.hcggzy.cn/gxhczbw/jyxx/001004/001004001/MoreInfo.aspx?CategoryNum=001004001',
            "http://www.hcggzy.cn/gxhczbw/jyxx/001009/001009001/MoreInfo.aspx?CategoryNum=001009001"
        ]
    ...
    def middle(self, response):
        ...
        for i in range(len(names)):
            url = "http://www.hcggzy.cn" + "".join(urls[i])
