...
class hz_gov_Spider(scrapy.Spider):
    name = "qinzhou_zhongbiao.py"
    allowed_domains = ["www.qzggzy.cn"]
    ...
    def start_requests(self):
        urls = [
            "http://www.qzggzy.cn/gxqzzbw/jyxx/001001/001001006/MoreInfo.aspx?CategoryNum=001001006",
            "http://www.qzggzy.cn/gxqzzbw/jyxx/001004/001004004/MoreInfo.aspx?CategoryNum=001004004"
        ]
    ...
    def middle(self, response):
        ...
        for i in range(len(names)):
            url = "http://www.qzggzy.cn" + "".join(urls[i])
