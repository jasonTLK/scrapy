...
class hz_gov_Spider(scrapy.Spider):
    name = "guigang_zhaobiao.py"
    allowed_domains = ["ggggzyjy.gov.cn"]
    ...
    def start_requests(self):
        urls = [
            "http://ggggzyjy.gov.cn/gxggzbw/ShowInfo/more.aspx?categoryNum=001001001",
            "http://ggggzyjy.gov.cn/gxggzbw/ShowInfo/more.aspx?categoryNum=001004001"
        ]
    ...
    def middle(self, response):
        ...
        for i in range(len(names)):
            url = "http://ggggzyjy.gov.cn" + "".join(urls[i])
