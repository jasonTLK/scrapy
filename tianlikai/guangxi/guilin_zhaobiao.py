...
class hz_gov_Spider(scrapy.Spider):
    ...
    def start_requests(self):
        urls = [
            "http://ggzy.guilin.cn/gxglzbw/showinfo/zbxxmore.aspx?categoryNum=001001001&Paging=",
            "http://ggzy.guilin.cn/gxglzbw/showinfo/zbxxmore.aspx?categoryNum=001004001&Paging="
        ]
        pages = [4, 54]
