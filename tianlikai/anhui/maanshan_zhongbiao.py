...
class hz_gov_Spider(scrapy.Spider):
    name = "maanshan_zhongbiao.py"
    allowed_domains = ["zbcg.mas.gov.cn"]
    ...
    def start_requests(self):
        urls = [
            ...
            "http://zbcg.mas.gov.cn/maszbw/jygg/028002/028002003/028002003001/MoreInfo.aspx?CategoryNum=028002003001"
        ]
    ...
    def middle(self, response):
        ...
        for i in range(len(names)):
            url = "http://zbcg.mas.gov.cn" + "".join(urls[i])
