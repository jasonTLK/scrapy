...
class hz_gov_Spider(scrapy.Spider):
    name = "qianxinan_zhongbiao.py"
    allowed_domains = ["ztb.qxn.gov.cn"]
    ...
    def start_requests(self):
        urls = [
            "http://ztb.qxn.gov.cn/qxnztb/jyxx/018001/018001004/MoreInfo.aspx?CategoryNum=018001004",
            "http://ztb.qxn.gov.cn/qxnztb/jyxx/018002/018002003/MoreInfo.aspx?CategoryNum=018002003"
        ]
    ...
    def middle(self, response):
        ...
        for i in range(len(names)):
            url = "http://ztb.qxn.gov.cn" + "".join(urls[i])
