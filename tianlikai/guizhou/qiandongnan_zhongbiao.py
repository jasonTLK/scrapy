...
class hz_gov_Spider(scrapy.Spider):
    name = "qiandongnan_zhongbiao.py"
    allowed_domains = ["www.qdnggzy.cn"]
    ...
    def start_requests(self):
        urls = [
            "http://www.qdnggzy.cn/qdnztb/jyxx/056001/056001004/MoreInfo.aspx?CategoryNum=056001004",
            "http://www.qdnggzy.cn/qdnztb/jyxx/056002/056002003/MoreInfo.aspx?CategoryNum=056002003"
        ]
    ...
    def middle(self, response):
        ...
        for i in range(len(names)):
            url = "http://www.qdnggzy.cn" + "".join(urls[i])
