...
class hz_gov_Spider(scrapy.Spider):
    ...
    def start_requests(self):
        urls = [
            ...
            "http://www.szggzyjyw.gov.cn/page/index_.jspx?type=notice&code=biddingNotice_purchase"
        ]

        urls2 = [
            "http://www.szggzyjyw.gov.cn/page/index.jspx?type=notice&code=biddingNotice_dyproject",
            "http://www.szggzyjyw.gov.cn/page/index.jspx?type=notice&code=cms_news_trade"
        ]
        urls3 = [
