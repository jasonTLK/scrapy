...
class hz_gov_Spider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        u3 =[
            "http://www.lfggzyjy.gov.cn/page/index.jspx?type=notice&code=resultNotice_dyproject",
            "http://www.lfggzyjy.gov.cn/page/index_2.jspx?type=notice&code=getBidding_purchase"
        ]
        pages = [40, 68]
