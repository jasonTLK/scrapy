...
class hz_gov_Spider(scrapy.Spider):
    ...
    def start_requests(self):
        urls = [
            "http://ggzy.llcftxw.gov.cn/gcjsZbgg/index_",
            "http://ggzy.llcftxw.gov.cn/zfcgZbgg/index_"
        ]
        urls2 = [
            "http://ggzy.llcftxw.gov.cn/gcjsZbgg/index.htm",
            "http://ggzy.llcftxw.gov.cn/zfcgZbgg/index.htm"
        ]
        pages = [15, 2]
