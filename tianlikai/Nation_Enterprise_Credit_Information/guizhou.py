...
class hz_gov_Spider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        url = "http://gz.gsxt.gov.cn/2016/gtgsh/xzxk.jsp?k=b149f38b5c7876ee8558b132ae9c5bdaf88edc803f93cc0819780e253130777b&ztlx=2&qylx=&a_iframe=xzxk_If"
    ...
    def parse2(self, response):
        ...
        sql[h1] = str
        db = insertMongo()
        db.Update_guizhou({"entId": entId}, {"$set": sql})
