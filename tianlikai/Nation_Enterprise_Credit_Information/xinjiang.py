...
class hz_gov_Spider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        url = 'http://xj.gsxt.gov.cn/gjjbj/gjjQueryCreditAction!openEntInfo.dhtml?entId=6500010001283081&clear=true&urltag=1&credit_ticket=EF622548A9B990431F7D3A2BD2915B5C'
    ...
    def parse2(self, response):
        ...
        # sql[h1] = str
        # db = insertMongo()
        # db.Update_xinjiang({"entId": entId}, {"$set": sql})
