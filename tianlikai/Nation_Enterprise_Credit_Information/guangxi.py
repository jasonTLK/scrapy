...
class hz_gov_Spider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        # data = get_uuid()
        url = "http://gx.gsxt.gov.cn/gjjbj/gjjQueryCreditAction!openEntInfo.dhtml?entId=24510000000076931&clear=true&urltag=1&credit_ticket=A36323E5BD2E033884D4F3CD4DB556BC"
    ...
    def parse2(self, response):
        ...
        sql[h1] = str
        db = insertMongo()
        db.Update_guangxi({"entId": entId}, {"$set": sql})
