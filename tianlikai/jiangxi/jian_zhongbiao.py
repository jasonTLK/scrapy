...
class hz_gov_Spider(scrapy.Spider):
    ...
    def start_requests(self):
        urls = [
            "http://www.japrtc.gov.cn/jsgc/zbgsjsgc.do?method=find_allZbgsBylx&pageSize=40&pageNo=",
            "http://www.japrtc.gov.cn/zfcg/zbgszfcg.do?method=find_allZbgsBylx&pageSize=40&pageNo=",
        ]
        pages = [101, 61]
