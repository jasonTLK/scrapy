...
class hz_gov_Spider(scrapy.Spider):
    ...
    def start_requests(self):
        urls = [
            "http://www.xczbtb.com/gzbgg/index_",
            "http://www.xczbtb.com/zzbgg/index_"
        ]
        urls2 = [
            "http://www.xczbtb.com/gzbgg/index.jhtml",
            "http://www.xczbtb.com/zzbgg/index.jhtml"
        ]
        pages = [2, 4]
