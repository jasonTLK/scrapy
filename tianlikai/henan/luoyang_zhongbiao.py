...
class hz_gov_Spider(scrapy.Spider):
    name = "luoyang_zhongbiao.py"
    allowed_domains = ["www.lyggzyjy.cn"]
    ...
    def start_requests(self):
        urls = [
            "http://www.lyggzyjy.cn/lyjyzx/jyxx/021001/021001003/MoreInfo.aspx?CategoryNum=021001003",
            "http://www.lyggzyjy.cn/lyjyzx/jyxx/021002/021002003/MoreInfo.aspx?CategoryNum=021002003"
        ]
    ...
    def middle(self, response):
        ...
        for i in range(len(names)):
            url = "http://www.lyggzyjy.cn" + "".join(urls[i])
