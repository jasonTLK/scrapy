...
class hz_gov_Spider(scrapy.Spider):
    ...
    def start_requests(self):
        urls = [
            "http://www.pdsggzy.com/gzbgg/index_",
            "http://www.pdsggzy.com/zzbgg/index_",
        ]
        urls2 = [
            "http://www.pdsggzy.com/gzbgg/index.jhtml",
            "http://www.pdsggzy.com/zzbgg/index.jhtml"
        ]
        pages = [11, 14]
