...
class hz_gov_Spider(scrapy.Spider):
    name = "zhoukou_zhongbiao.py"
    allowed_domains = ["www.zkggzyjy.gov.cn"]
    ...
    def start_requests(self):
        urls = [
            "http://www.zkggzyjy.gov.cn/zkweb/ZtbPages/MoreInfoList.aspx?CategoryNum=002001003",
            "http://www.zkggzyjy.gov.cn/zkweb/ZtbPages/MoreInfoList.aspx?CategoryNum=002002003"
        ]
    ...
    def middle(self, response):
        ...
        for i in range(len(names)):
            url = "http://www.zkggzyjy.gov.cn" + "".join(urls[i])
