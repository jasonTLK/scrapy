...
class hz_gov_Spider(scrapy.Spider):
    name = "suqian_zhongbiao.py"
    allowed_domains = ["www.sqggzyjy.gov.cn"]
    ...
    def start_requests(self):
        urls = [
            "http://www.sqggzyjy.gov.cn/sqzbtb/jyxx/008001/008001006/MoreInfo.aspx?CategoryNum=008001006",
            "http://www.sqggzyjy.gov.cn/sqzbtb/jyxx/008002/008002003/MoreInfo.aspx?CategoryNum=008002003"
        ]
    ...
    def middle(self, response):
        ...
        for i in range(len(names)):
            url = "http://www.sqggzyjy.gov.cn" + "".join(urls[i])
