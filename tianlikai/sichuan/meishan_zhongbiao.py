...
class hz_gov_Spider(scrapy.Spider):
    ...
    def start_requests(self):
        urls = [
            "http://www.msggzy.org.cn/msweb/gcjs/003005/MoreInfo.aspx?CategoryNum=003005",
            "http://www.msggzy.org.cn/msweb//zfcg/005004/MoreInfo.aspx?CategoryNum=005004"
        ]
    ...
    def middle(self, response):
        ...
        for i in range(len(names)):
            url = "http://www.msggzy.org.cn" + "".join(urls[i])
