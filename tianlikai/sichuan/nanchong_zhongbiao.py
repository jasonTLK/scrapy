...
class hz_gov_Spider(scrapy.Spider):
    ...
    def start_requests(self):
        urls = [
            "http://ggzy.scnczw.gov.cn/TPFront/front_zfcg/071005/moreinfo.aspx?Paging=",
            "http://ggzy.scnczw.gov.cn/TPFront/front_gcjs/072004/moreinfo.aspx?Paging=",
        ]
        pages = [16, 3]
