...
class hz_gov_Spider(scrapy.Spider):
    ...
    def start_requests(self):
        urls = [
            "http://www.plsggzyjy.cn/Handlers/InfoPageTrade.ashx?pageIndex=",
            "http://www.plsggzyjy.cn/Handlers/InfoPageTrade.ashx?pageIndex=",
            "http://www.plsggzyjy.cn/Handlers/InfoPageTrade.ashx?pageIndex=",
            "http://www.plsggzyjy.cn/Handlers/InfoPageTrade.ashx?pageIndex=",
            "http://www.plsggzyjy.cn/Handlers/InfoPageTrade.ashx?pageIndex="
        ]
        pages = [83, 44, 22, 13, 28]
        urls2 = [
            "&pageSize=30&siteItem=46&infoType=&query=",
            "&pageSize=30&siteItem=27&infoType=&query=",
            "&pageSize=30&siteItem=28&infoType=&query=",
            "&pageSize=30&siteItem=29&infoType=&query=",
            "&pageSize=30&siteItem=31&infoType=&query="
        ]
    ...
    # start_urls = [
    #     'http://www.plsggzyjy.cn/Handlers/InfoPageTrade.ashx?pageIndex=1&pageSize=30&siteItem=46&infoType=&query='
    # ]
    ...
    def parse(self, response):
        ...
        for i in range(len(names)):
            url = "".join(urls[i]).replace("../", "http://www.plsggzyjy.cn/")
    ...
    def parse3(self, response):
        ...
        filePath = "/user/hadoop/bidding/GanSu/PingLiang/" + str(hashName) + ".pdf"
