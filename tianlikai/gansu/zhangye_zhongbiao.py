...
class hz_gov_Spider(scrapy.Spider):
    ...
    def start_requests(self):
        urls = [
            "http://www.zyggzy.com/Handlers/InfoPageTrade.ashx?pageIndex=",
            "http://www.zyggzy.com/Handlers/InfoPageTrade.ashx?pageIndex=",
            "http://www.zyggzy.com/Handlers/InfoPageTrade.ashx?pageIndex="
        ]
        pages = [58, 32, 3]
        urls2 = [
            ...
            '&pageSize=30&siteItem=109&infoType=&query='
        ]
    ...
    def parse(self, response):
        ...
        for i in range(len(names)):
            url = "".join(urls[i]).replace("../", "http://www.zyggzy.com/")
    ...
    def parse3(self, response):
        ...
        filePath = "/user/hadoop/bidding/GanSu/ZhangYe/"+str(hashName)+".pdf"
