...
class hz_gov_Spider(scrapy.Spider):
    name = "zaozhuang_zhongbiao.py"
    allowed_domains = ["zzggzy.com"]
    ...
    # start_urls = [
    #     "http://www.zzggzy.com/TPFront/jyxx/070001/070001005/?Paging=1"
    # ]
    ...
    def parse(self, response):
        ...
        for i in range(len(names)):
            url = "http://www.zzggzy.com" + "".join(urls[i])
