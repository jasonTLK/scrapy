...
class hz_gov_Spider(scrapy.Spider):
    name = "dongying_zhongbiao.py"
    allowed_domains = ["www.dyggzyjy.gov.cn"]
    ...
    def start_requests(self):
        urls = [
            "http://www.dyggzyjy.gov.cn/dysite/004/004001/004001003/004001003001/MoreInfo.aspx?CategoryNum=004001003001",
    ...
    def middle(self, response):
        ...
        for i in range(len(names)):
            url = "http://www.dyggzyjy.gov.cn" + "".join(urls[i])
