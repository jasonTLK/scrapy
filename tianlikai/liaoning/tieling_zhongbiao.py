...
class hz_gov_Spider(scrapy.Spider):
    ...
    def start_requests(self):
        urls = [
            ...
            "http://tlggzyjy.com/Project/Index/",
            "http://tlggzyjy.com/Project/Index/",
            "http://tlggzyjy.com/Project"
        ]
        url2=[
            "?ProjectState=3&CountyId=1&TradeTypeId=1",
            "?ProjectState=3&CountyId=2&TradeTypeId=1",
            "?ProjectState=3&CountyId=4&TradeTypeId=1",
            "?ProjectState=3&CountyId=6&TradeTypeId=1"
        ]
        pages = [3, 2, 2, 1]
