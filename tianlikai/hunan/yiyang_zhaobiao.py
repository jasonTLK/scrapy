...
class hz_gov_Spider(scrapy.Spider):
    ...
    def start_requests(self):
        urls = [
            "http://www.ccgp-hunan.gov.cn:8080/mvc/getNoticeList4WebCity.do?nType=prcmNotices&pType=&prcmPrjName=&prcmItemCode=&prcmOrgName=&startDate=&endDate=&area_id=79&page="
        ]
        pages = [11]
